module.exports = {
  order: {
    ...
    processing: {
      ...
      description: 'Yến Sào DamiNest đang chuẩn bị sản phẩm để giao cho quý khách. Yến Sào DamiNest sẽ cố gắng giao hàng cho quý khách trong thời gian sớm nhất.'
    },
    transferring: {
      ...
      description: 'Yến Sào DamiNest rất mong quý khách có thể dành ít phút để nhận xét những sản phẩm bạn đã mua gần đây.'
    },
    reject: {
      title: '[#{{orderId}}] Đơn hàng của quý khách bị từ chối',
      description: 'Yến Sào DamiNest rất tiếc khi thông báo đơn hàng #{{orderId}} của quý khách bị từ chối do {{reasons}}'
    }
  }
}
